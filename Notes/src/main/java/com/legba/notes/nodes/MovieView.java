...
public class MovieView extends Region {
    ...
    private void addToolBar() {
        ...
        System.out.println(getClass().getClassLoader().getResource("com/legba/notes/nodes/icons/volume_off.png"));
        muteIcon.setImage(new Image(getClass().getClassLoader().getResource("com/legba/notes/nodes/icons/volume_off.png").toExternalForm(), 24.0, 24.0, true, false));
